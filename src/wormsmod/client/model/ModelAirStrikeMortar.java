...
public class ModelAirStrikeMortar extends ModelBase implements IBaseModel{
    //fields
    ...
    public ModelAirStrikeMortar(){
        ...
        Shape3.setRotationPoint(-2.5F, 21F, -2.5F);
        ...
        Shape8 = new ModelRenderer(this, 24, 3);
        Shape8.addBox(0F, 0F, 0F, 3, 2, 3);
        Shape8.setRotationPoint(-1.5F, 15F, -1.5F);
        Shape8.setTextureSize(64, 32);
        Shape8.mirror = true;
        setRotation(Shape8, 0F, 0F, 0F);
        Shape9 = new ModelRenderer(this, 24, 8);
        Shape9.addBox(0F, 0F, 0F, 1, 3, 1);
        Shape9.setRotationPoint(1F, 14F, -2F);
        Shape9.setTextureSize(64, 32);
        Shape9.mirror = true;
        setRotation(Shape9, 0F, 0F, 0F);
        Shape10 = new ModelRenderer(this, 24, 12);
        Shape10.addBox(0F, 0F, 0F, 1, 3, 1);
        Shape10.setRotationPoint(1F, 14F, 1F);
        Shape10.setTextureSize(64, 32);
        Shape10.mirror = true;
        setRotation(Shape10, 0F, 0F, 0F);
        Shape11 = new ModelRenderer(this, 24, 16);
        Shape11.addBox(0F, 0F, 0F, 1, 3, 1);
        Shape11.setRotationPoint(-2F, 14F, -2F);
        Shape11.setTextureSize(64, 32);
        Shape11.mirror = true;
        setRotation(Shape11, 0F, 0F, 0F);
        Shape12 = new ModelRenderer(this, 24, 20);
        Shape12.addBox(0F, 0F, 0F, 1, 3, 1);
        Shape12.setRotationPoint(-2F, 14F, 1F);
