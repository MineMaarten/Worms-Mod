...
public class NetworkHandler{
    ...
    public static final SimpleNetworkWrapper INSTANCE = NetworkRegistry.INSTANCE.newSimpleChannel("WormsMod");
    ...
    public static void init(){
        ...
        INSTANCE.registerMessage(MessageMultiParticle.class, MessageMultiParticle.class, discriminant++, Side.CLIENT);
    }
