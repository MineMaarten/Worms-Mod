...
public class Textures{
    public static final String MOD_ID = "wormsmod:";
    public static final String MODEL_LOCATION = MOD_ID + "textures/model/";
    public static final String GUI_LOCATION = MOD_ID + "textures/gui/";
    ...
    public static final ResourceLocation MODEL_AIR_STRIKE_MORTAR = new ResourceLocation(MODEL_LOCATION + "AirStrikeMortar.png");
    public static final ResourceLocation MODEL_HOLY_HAND_GRENADE = new ResourceLocation(MODEL_LOCATION + "HolyHandGrenade.png");
